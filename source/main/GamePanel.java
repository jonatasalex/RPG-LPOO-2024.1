...
public class GamePanel extends JPanel implements Runnable {
    ...
    final double tileSizeTimes = originalTileSize*scale; //40x40
    final int tileSize = (int)tileSizeTimes;
    ...
    private UI ui; // Adicionada a instância da UI
    ...
    public GamePanel(){
        ...
        player = mapa.getControleDeEntidades().criarPlayer("Player", "Guerreiro", "Silvio", "Humano", this, keyH, mapa);
