...
public class Player extends Entidade {
    ...
    public void update(){
        ...
        ArrayList<ArrayList<Objeto>> a = getCurrentLocation().getSuperficieObjetos();
...
//            	int i;
//            	i = getStatus().getVelocidade();
//            	i = i - 1;
//            	getStatus().setVelocidade(i);
...
//            		System.out.println(getCurrentLocation().getSuperficie().get(((getiY()-1))).get(getiX()));
...
//            		System.out.println(getCurrentLocation().getSuperficieObjetos().get(((getiY()+1))).get(getiX()+1));
...
//            	sai(getCurrentLocation().getPortoes().get(0));
//            	int i;
//            	i = getStatus().getVelocidade();
//            	i = i + 1;
//            	getStatus().setVelocidade(i);
...
//            System.out.println(getCurrentLocation());        
            ...
            // System.out.println(getiX());
            // System.out.println(getiY());
